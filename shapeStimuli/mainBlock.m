...
%% Generate stimulus conditionstrialOrder = carryoverCounterbalance(4,1,7,0);
%%legend:   [imageA/B, OddBall, High/Low contrast]
%%          Fact 1 = bin for image A, High Contrast, OddBall
%%          Fact 2 = bin for image B, High Contrast, OddBall
%%          Fact 3 = bin for image A, low Contrast, OddBall
