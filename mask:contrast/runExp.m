...
for iBlock = 1:G.nBlock   
    ...
    switch G.blockType{iBlock}{1};
        case 'cont'
            cfg = [];
            cfg.nNormal = G.contBlock.nNormal;
            cfg.nOddball = G.contBlock.nOddball;
