function [dataFile, logFile] = locBlock(cfg0)
...
% Normals
condNorm = [ ...
    repmat([1, 0], [cfg0.nNormal(1, 1), 1]); ...
    repmat([2, 0], [cfg0.nNormal(1, 2), 1]); ...
];    
...
% Oddballs
condOB = [ ...
    repmat([1, 1], [cfg0.nOddball(1, 1), 1]); ...
    repmat([2, 1], [cfg0.nOddball(1, 2), 1]); ...
];    
